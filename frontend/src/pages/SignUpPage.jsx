...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-1">
      ...
      {/* right side */}
      {/* 
        You can add an image or branding here for larger screens.
        Example: <img src="/signup-illustration.svg" alt="Sign Up Illustration" className="hidden lg:block object-cover w-full h-full" />
      */}
    </div>
  );
};
